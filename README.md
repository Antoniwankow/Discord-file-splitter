...
- [Использование](#-использование)
  - [Разбивка файла](#-разбивка-файла)
  - [Сборка файла](#-сборка-файла)
- [Установка](#-установка)
...
Нашли баг? Есть идея? Мы рады вкладу!

1. Форкните репозиторий
2. Создайте ветку: git checkout -b feature/крутая-фича
3. Закомитьте изменения: git commit -m 'Добавил крутую фичу'
...
Если этот инструмент спас вас от головной боли с файлообменниками:

· ⭐ Поставьте звезду — это поможет другим найти репозиторий
· 🐛 Сообщите о баге — откройте issue
· 💬 Поделитесь — расскажите друзьям в Discord
· 🔧 Внесите вклад — пул-реквесты приветствуются
