...
1. **Через загрузчик (рекомендуется)** — откройте в браузере файл загрузчика, который автоматически подхватит актуальную версию. Загрузчик сохранит приложение в кэш, и в дальнейшем оно будет работать даже без интернета.
2. **Скачать напрямую** — вы можете скачать ZIP-архив с последней версией и распаковать его в удобное место, затем открыть `discord-file-splitter.html`.
