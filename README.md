...
- ⬇️ **Автоскачивание** разбитых и собранных частей (требуется включения опции в настройках)
...
3. Нажмите и укажите файл для разбивки или просто перетащите в соответствующее поле
